...
public class ParseProto {
    public final String PROTOC_DIR = "F:\\protocolbuffer\\bin\\protoc.exe "; // protoc.exe所在文件夹
    public final String PROTO_FILE_DIR = "F:\\study\\snail-jraft\\src\\test\\java\\zhangjie\\raft\\protocol\\fileDescriptorSet\\"; // protoc.exe所在文件夹
